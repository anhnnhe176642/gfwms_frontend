...
export const PERMISSIONS = {
  ...
  CREDITS: {
    ...
    DELETE: {
      key: 'credit:delete',
      description: 'Xóa đăng ký Công nợ',
      parentPermissionKey: 'credit:view_list',
      level: 2,
    },
    APPROVE: {
      key: 'credit:approve',
      description: 'Phê duyệt đăng ký Công nợ',
      parentPermissionKey: 'credit:view_list',
      level: 2,
    },
    REJECT: {
      key: 'credit:reject',
      description: 'Từ chối đăng ký Công nợ',
      parentPermissionKey: 'credit:view_list',
      level: 2,
    },
    VIEW_OWN: {
      key: 'credit:view_own',
      description: 'Xem đăng ký Công nợ của mình',
      level: 0,
    },
  },
  ...
  ORDERS: {
    ...
    CHECK_CUSTOMER_CREDIT: {
      ...
      description: 'Kiểm tra Công nợ khách hàng',
      parentPermissionKey: 'order:view_list',
      level: 2,
    },
  },
  ...
  CREADIT_REGISTRATION: {
    ...
    CREDIT_SCORE: {
      ...
      description: 'Xem điểm uy tín và gợi ý hạn mức Công nợ',
      parentPermissionKey: 'creadit_registration:view_list',
      level: 2,
    },
  },
